...
export const EditCreateServiceForm: React.FC<Props> = ({ category, service, onFinish }) => {
    ...
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="px-4">
        <FieldGroup>
                ...
                <Input
                  ...
                  onBlur={(e) => {
                    if (!form.getValues().icon) {
                      const icon = e.target.value.replaceAll(" ", "-").toLowerCase()
                      if (icon === "") return
                      form.setValue(
                        "icon",
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                ...
                <Input {...field} placeholder="Service url" aria-invalid={fieldState.invalid} />
                {fieldState.invalid && <FieldError errors={[fieldState.error]} />}
              </Field>
            )}
          />
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                <Field
                  ...
                  className="flex items-start space-y-0 space-x-3 rounded-md border p-3"
                >
                  <Checkbox
                    name={field.name}
                    checked={field.value}
            ...
            <Controller
              ...
              render={({ field, fieldState }) => (
                ...
                >
                  ...
                  />
                  <div className="space-y-1 leading-none">
                    <FieldLabel htmlFor={field.name}>Open in new tab (mobile)</FieldLabel>
                  </div>
                </Field>
              )}
            />
          ...
          <Button
            type="submit"
            disabled={createServiceMutation.isPending || editServiceMutation?.isPending}
            className="ml-auto"
          >
            Submit
          </Button>
